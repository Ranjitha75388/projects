...
**Step 4:** Check and Change access level to "Blob (anonymous read access for blobs only)"  if it is private access(Step-3).
 ...
 **Step 3:** Update NSG
 ...
 1. Alllow NSG form public to public vm.and connect to private vm.
 2. Allow traffic from vnet to storage for private subnet

  ![image](https://github.com/user-attachments/assets/5721ea2b-0655-44a9-8b07-69240dd89610)
  ![image](https://github.com/user-attachments/assets/d14ad659-c146-4b2d-99c5-fc3d060c981b)
...
**Step 5:** Upload a file to container.

**Step 6:** Generate SAS Token

- Choose container → 3 dots → Generate SAS
...
**Step 1:** Under Networking > Disable public access

![image](https://github.com/user-attachments/assets/61523295-cb9e-4f63-9dfc-faf0955d746d)

**Step 2:** Create Private Endpoint in Storage Account
...
**Step 3:** Deny public access to storage account from public vm
