...
--------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------
### ERROR FACED:Created kubeconfig file automatically

#### "az aks get-credentials" directly, it may fetch "admin credentials" ,so  it connects with all namespace which is not correct..User need to access resourses under specific namespace.
...
### Create pods under jumisa-namespace for prabhu-user.

![image](https://github.com/user-attachments/assets/cadc1ca4-f3e0-4e90-aecc-fdb693f6995e)
