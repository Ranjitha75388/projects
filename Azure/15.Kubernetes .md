...
### 2.Minikube – Local Kubernetes on Your Laptop
...
#### 1.Manual Setup (Kubernetes The Hard Way)
...
- How AKS Works
   ...
   - Microsoft Azure sets up and manages the Kubernetes control plane (API Server, Scheduler, Controller Manager, etcd.).
