...
-    Add DNS Records in Azure DNS:
 ...
 ### How a User Accesses a Website Hosted on Azure via cloudflare?
   **Example Scenario:**

  -  A user types www.ranjitha.dreamteamit.in in their browser.
  -  The browser sends a DNS query to the user’s ISP DNS resolver.
  -  The resolver checks cloudflare’s nameservers, which point to Azure DNS.
