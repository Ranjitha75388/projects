...
![image](https://github.com/user-attachments/assets/5d1547a9-2169-4a9e-a477-c006df905e6b)
...
-    Add DNS Records in Azure DNS:
 ...
 ### How a User Accesses a Website Hosted on Azure via GoDaddy?
   **Example Scenario:**

  -  A user types www.mywebsite.com in their browser.
  -  The browser sends a DNS query to the user’s ISP DNS resolver.
  -  The resolver checks GoDaddy’s nameservers, which point to Azure DNS.
  -  Azure DNS responds with the IP address of the web server.
  -  The browser connects to the Azure-hosted website (e.g., on an Azure Virtual Machine, Azure App Service, or Application Gateway).
...
* Add name,ip address in Record sets
